...
enum combos { F1_F12_L7 };

const uint16_t PROGMEM f1_f12_combo[] = {KC_F1, KC_F12, COMBO_END};
const uint16_t PROGMEM f_j_combo[]    = {KC_F, KC_J, COMBO_END};

combo_t key_combos[] = {COMBO(f1_f12_combo, TG(7)), COMBO(f_j_combo, KC_EQL)};
